...
public struct EntryTranslationsEditor {
    ...
    public enum Action: BindableAction {
        ...
        case movedTranslations(fromOffsets: IndexSet, toOffset: Int)
    ...
    public var body: some ReducerOf<Self> {
        ...
        Reduce<State, Action> { state, action in
            ...
            case .movedTranslations(let fromOffsets, let toOffset):
...
struct EntryTranslationsEditorView: View {
    ...
    var body: some View {
        Section {
            ...
            .onMove { from, to in
                store.send(.movedTranslations(fromOffsets: from, toOffset: to))
            }
...
struct EntryTranslationsEditorViewModifier: ViewModifier {
    
    let store: StoreOf<EntryTranslationsEditor>
