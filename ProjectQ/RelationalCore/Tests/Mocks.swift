...
extension Database {
    ...
    static func mockConnected(entries: Range<Int>, created: Date) -> Self {
        var result = Self.init()
        entries.forEach {
            result.create(.entry(.init(id: .mock($0), spelling: "\($0)")), now: created)
        }
    ...
    static func mock(languages: Range<Int>, created: Date) -> Self {
        var result = Self.init()
        languages.forEach {
    ...
    static func mockConnected(languages range: Range<Int>, entries eRange: Range<Int>, created: Date) -> Self {
        var result = Self.init()
    ...
    static func mock(keywords: Range<Int>, created: Date) -> Self {
        var result = Self.init()
        keywords.forEach {
    ...
    static func mockConnected(keyword range: Range<Int>, entries eRange: Range<Int>, created: Date) -> Self {
        var result = Self.init()
    ...
    static func mock(notes: Range<Int>, created: Date) -> Self {
        var result = Self.init()
        notes.forEach {
    ...
    static func mockConnected(notes range: Range<Int>, entries eRange: Range<Int>, created: Date) -> Self {
        var result = Self.init()
        let notes = range.map({
    ...
    static func mock(usages: Range<Int>, created: Date) -> Self {
        var result = Self.init()
        usages.forEach {
    ...
    static func mockConnected(usages range: Range<Int>, entries eRange: Range<Int>, created: Date) -> Self {
        var result = Self.init()
    ...
    static func mock(entryCollections: Range<Int>, created: Date) -> Self {
        var result = Self.init()
    ...
    static func mockConnected(entryCollections range: Range<Int>, entries eRange: Range<Int>, created: Date) -> Self {
        var result = Self.init()
...
extension Language {
    static func mock(_ int: Int) -> Self {
        try! .init(bcp47: "en_US_\(int)")
    }
}
extension Language.ID {
    static func mock(_ int: Int) -> Language.ID {
