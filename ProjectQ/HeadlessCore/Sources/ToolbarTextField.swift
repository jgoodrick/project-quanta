...
//        HStack(spacing: 0) {
////            ConfigurableTextField(text: $store.text) {
////                $0.placeholder = placeholder
////                $0.isFirstResponder = store.focused
////                $0.preferredLanguage = languageIdentifier
////                $0.autocapitalization = style.autocapitalization
////                $0.autocorrectionDisabled = style.autocorrection.isDisabled
////                $0.adjustsFontSizeToFitWidth = true
////                $0.onLanguageUnavailable = {
